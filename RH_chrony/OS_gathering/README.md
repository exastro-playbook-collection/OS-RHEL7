Ansible Role: OS-RHEL7/RH_chrony/OS_gathering
=======================================================
# Description
本ロールは、RHEL7に関する時刻同期設定についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/RH_chrony/`
...
| Path | Description | 
| ---- | ----------- | 
| `/etc/chrony.conf` | /etc/chrony.confファイル | 
| `/etc/chrony.keys` | /etc/chrony.keysファイル | 

## 生成したパラメータの出力例

生成したパラメータは以下のディレクトリ・ファイル名で出力します。

- `<VAR_extracting_dest>/<ホスト名/IP>/OS/RH_chrony.yml`
