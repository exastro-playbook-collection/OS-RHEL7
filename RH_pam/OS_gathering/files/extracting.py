...
target_filepath_list.append('/etc/pam.d/system-auth-ac')
target_filepath_list.append('/etc/pam.d/password-auth-ac')
target_filepath_list.append('/etc/login.defs')
...
result = {}
target_parameter_root_key = 'VAR_RH_pam'
