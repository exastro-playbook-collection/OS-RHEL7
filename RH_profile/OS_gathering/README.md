...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/RH_profile/`
...
| Path | Description | 
| ---- | ----------- | 
| `/etc/bashrc` | /etc/bashrcファイル | 
| `/etc/csh.cshrc` | /etc/csh.cshrcファイル | 
| `/etc/csh.login` | /etc/csh.loginファイル | 

## 生成したパラメータの出力例

生成したパラメータは以下のディレクトリ・ファイル名で出力します。

- `<VAR_extracting_dest>/<ホスト名/IP>/OS/RH_profile.yml`
