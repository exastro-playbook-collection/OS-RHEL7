Ansible Role: OS-RHEL7/RH_directory/OS_gathering
=======================================================
# Description
本ロールは、RHEL7に関するディレクトリ設定についての情報の取得を行います。
...
| `VAR_OS_gathering_dir_path` | - /boot<br>- /usr/*<br>- /home/* | 情報を取得するディレクトリのパス | 
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/RH_directory/`
...
- `<VAR_extracting_dest>/<ホスト名/IP>/OS/RH_directory.yml`
