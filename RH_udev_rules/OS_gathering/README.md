Ansible Role: OS-RHEL7/RH_udev_rules/OS_gathering
=======================================================
# Description
本ロールは、RHEL7に関するデバイスルール設定についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/RH_udev_rules/`
...
| Path | Description | 
| ---- | ----------- | 
| `/etc/udev/rules.d/*` | /etc/udev/rules.d/配下のファイル | 

## 生成したパラメータの出力例

生成したパラメータは以下のディレクトリ・ファイル名で出力します。

- `<VAR_extracting_dest>/<ホスト名/IP>/OS/RH_udev_rules.yml`
