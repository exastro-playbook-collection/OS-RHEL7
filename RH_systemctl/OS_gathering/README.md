Ansible Role: OS-RHEL7/RH_systemctl/OS_gathering
=======================================================
# Description
本ロールは、RHEL7に関するシステムサービス起動制御についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/RH_systemctl/`
...
- `<VAR_extracting_dest>/<ホスト名/IP>/OS/RH_systemctl.yml`
