Ansible Role: OS-RHEL7/RH_kdump/OS_gathering
=======================================================
# Description
本ロールは、RHEL7に関するカーネルダンプ設定についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/RH_kdump/`
...
| Path | Description | 
| ---- | ----------- | 
| `/etc/kdump.conf` | /etc/kdump.confファイル | 

## 生成したパラメータの出力例

生成したパラメータは以下のディレクトリ・ファイル名で出力します。

- `<VAR_extracting_dest>/<ホスト名/IP>/OS/RH_kdump.yml`
